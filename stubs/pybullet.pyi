...
# From: https://github.com/rohit-kumar-j/temporary_pybullet_stub.git
...
def addUserDebugParameter(
    paramName: str, rangeMin: float, rangeMax: float, startValue: float, physicsClientId: int, *args, **kwargs
):  # real signature unknown
...
def computeProjectionMatrix(
    left: float, right: float, bottom: float, up: float, near: float, far: float, physicsClientId: int, *args, **kwargs
):  # real signature unknown
    """Compute a camera projection matrix from screen left/right/bottom/top/near/far values"""
    pass

def computeProjectionMatrixFOV(
    fov: float, aspect: float, nearVal: float, farVal: float, physicsClientId: int, *args, **kwargs
):  # real signature unknown
...
def enableJointForceTorqueSensor(
    bodyUniqueId: int, jointIndex: int, enableSensor: int, physicsClientId: int, *args, **kwargs
):  # real signature unknown
...
def getClosestPoints(
    bodyA: int, bodyB: int, distance: float, linkIndexA: int, linkIndexB: int, physicsClientId: int = 0, *args, **kwargs
):  # real signature unknown
...
def getDifferenceQuaternion(
    quaternionStart: list[float], quaternionEnd: list[float], physicsClientId: int = 0, *args, **kwargs
):  # real signature unknown
...
def getJointStates(
    bodyUniqueId: int, jointIndices: list[int], physicsClientId: int = 0, *args, **kwargs
):  # real signature unknown
...
def getMeshData(
    bodyUniqueId: int, linkIndex: int, collisionShapeIndex: int, flags: int, physicsClientId: int = 0, *args, **kwargs
):  # real signature unknown
...
def getOverlappingObjects(
    aabbMin: list[float], aabbMax: list[float], physicsClientId: int = 0, *args, **kwargs
):  # real signature unknown
...
def loadMJCF(
    fileName: str, useMaximalCoordinates: int, globalScaling: float, physicsClientId: int = 0, *args, **kwargs
):  # real signature unknown
...
def loadURDF(
    fileName: str,
    basePosition: list[float] | None = None,
    baseOrientation: list[float] | None = None,
...
def rayTest(
    rayFromPosition: list[float], rayToPosition: list[float], physicsClientId: int = 0, *args, **kwargs
):  # real signature unknown
...
def resetBasePositionAndOrientation(
    bodyUniqueId: int, posObj: list[float], ornObj: list[float], physicsClientId: int = 0, *args, **kwargs
):  # real signature unknown
...
def resetJointState(
    objectUniqueId: int, jointIndex: int, targetValue: float, targetVelocity: int = 0, physicsClientId: int = 0
):  # real signature unknown; restored from __doc__
    """
...
def resetJointStateMultiDof(
    objectUniqueId: int, jointIndex: int, targetValue: int, targetVelocity=0, physicsClientId: int = 0
):  # real signature unknown; restored from __doc__
    """
...
def setDebugObjectColor(
    objectUniqueId: int, linkIndex: int, objectDebugColorRGB: list[float], physicsClientId: int = 0, *args, **kwargs
):  # real signature unknown
...
__loader__ = None  # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001D8BC7CE2E0>'  # noqa: A001

__spec__ = None  # (!) real value is "ModuleSpec(name='pybullet', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001D8BC7CE2E0>, origin='C:\\\\Users\\\\Rohit\\\\PycharmProjects\\\\Test_Project\\\\venv\\\\lib\\\\site-packages\\\\pybullet.cp38-win_amd64.pyd')"  # noqa: A001
