...
def calculateJacobian(
    bodyUniqueId, linkIndex, localPosition, objPositions, objVelocities, objAccelerations, physicsClientId=...
) -> Any: ...
...
def getLinkState(
    objectUniqueId, linkIndex, computeLinkVelocity=..., computeForwardKinematics=..., physicsClientId=...
) -> Any: ...
...
def resetJointStateMultiDof(
    objectUniqueId, jointIndex, targetValue, targetVelocity=..., physicsClientId=...
) -> Any: ...
def resetJointStatesMultiDof(
    objectUniqueId, jointIndices, targetValues, targetVelocities=..., physicsClientId=...
) -> Any: ...
